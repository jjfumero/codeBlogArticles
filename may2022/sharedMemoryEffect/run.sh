...
## Running from 64MB to 8GB per buffer
## Extended Alloc Memory Mode needed
#sizes=( 16777216 33554432 67108864 134217728 268435456 536870912 1073741824 2147483648 )
